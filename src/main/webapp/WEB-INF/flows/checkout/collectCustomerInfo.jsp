	...
	<div class="container">
		...
		<div class="registration">
			<div class="registration_left">
				<h4>
					<spring:message code="collectCustomerInfo.Explanation"></spring:message>
				</h4>
				<!-- [if IE] 
			 ...
			 <! [endif] -->
				...
				<div class="registration_form">
					...
					<form:form modelAttribute="order.customer" class="formhorizontal">
						<div>
							<label> <form:input id="customerName" path="name"
									type="text" class="form:input-large" placeholder="Ваше имя"
									tabindex="1" />
							</label>
						</div>

						<div>
							<label> <form:input id="customerPhone" path="phoneNumber"
									type="text" class="form:input-large" placeholder="Ваш телефон..." />
							</label>
						</div>
						...
						<div>
							<input type="submit" id="register-submit" class="btn btn-primary"
								value="Продолжить" name="_eventId_customerInfoCollected" />
